...
public class Session {
    ...
    /**
     * @return an <code>Enumeration</code> of <code>String</code> objects containing the names of all the objects bound
     * to this session.
     */
    ...
    /**
     * @return the maximum time interval, in seconds, that the container will keep this session open between client
     * accesses.
     */
