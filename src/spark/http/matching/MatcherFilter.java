...
public class MatcherFilter implements Filter {
     ...
     * @param externalContainer Tells the filter that Spark is run in an external web container. If true, chain.doFilter
     *                          will be invoked if request is not consumed by Spark.
     * @param hasOtherHandlers  If true, do nothing if request is not consumed by Spark in order to let others handlers
     *                          process the request.
     */
