...
/**
 * Holds the custom error pages. A page can be defined as a String or a Route. Note that this class is always used
 * statically therefore custom error pages will be shared between different instances of the Service class.
 */
public class CustomErrorPages {
    ...
    /**
     * Gets the custom error page for a given status code.  If the custom error page is a route, the output of its
     * handle method is returned. If the custom error page is a String, it is returned as an Object.
     *
     * @param status
     * @param request
     * @param response
