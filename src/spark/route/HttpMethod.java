...
public enum HttpMethod {
    ...
    /**
     * Gets the HttpMethod corresponding to the provided string. If no corresponding method can be found {@link
     * spark.route.HttpMethod#unsupported} will be returned.
     *
