...
/**
 * These objects represent the parameters sent on a Http Request. <br> Parses parameters keys like in Sinatra. <br>
 * <br>
 * For a querystring like: <br> user[name]=federico&#38;user[lastname]=dayan
 * <br>
 * <br>
 * We get a structure like: <br> user : {name: federico, lastname: dayan}
 * <br>
 * <br>
 * That is:<br> queryParamsMapInstance.get("user").get("name").value(); <br> queryParamsMapInstance.get("user").get("lastname").value();
 * <br><br>
...
public class QueryParamsMap {
    ...
    /**
     * Creates a new QueryParamsMap from an HttpServletRequest. <br> Parses the parameters from
     * request.getParameterMap() <br> No need to decode, since HttpServletRequest does it for us.
     *
    ...
    /**
     * Parses the key and creates the child QueryParamMaps user[info][name] creates 3 nested QueryParamMaps. For user,
     * info and name.
     *
    ...
    /**
     * Returns an element from the specified key. <br> For querystring: <br>
     * <br>
     * user[name]=fede
     * <br>
     * <br>
    ...
    /**
     * Returns the value for this key. <br> If this key has nested elements and does not have a value returns null.
     *
     * @return the value
     */
    public String value() {
    ...
    /**
     * Returns the value for that key. <br> It is a shortcut for: <br>
     * <br>
     * <code>
