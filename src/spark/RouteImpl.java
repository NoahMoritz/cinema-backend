...
public abstract class RouteImpl implements Route, Wrapper {
    ...
    /**
     * This method should render the given element into something that can be send through Response element. By default
     * this method returns the result of calling toString method in given element, but can be overridden.
     *
