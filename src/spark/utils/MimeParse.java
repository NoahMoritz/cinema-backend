...
public class MimeParse {
     ...
     * MimeParse.parseMediaRange(). Returns a tuple of the fitness value and the value of the 'q' quality parameter of
     * the best match, or (-1, 0) if no match was found. Just as for quality_parsed(), 'parsed_ranges' must be a list of
     * parsed media ranges.
     *
     * @param mimeType
     * @param parsedRanges
    ...
    /**
     * Carves up a media range and returns a ParseResults. For example, the media range 'application/*;q=0.5' would get
     * parsed into: ('application', '*', {'q', '0.5'}) In addition this function also guarantees that there is a value
     * for 'q' in the params dictionary, filling it in with a proper default if necessary.
     *
     * @param range
     */
    ...
    /**
     * Carves up a mime-type and returns a ParseResults object For example, the media range 'application/xhtml;q=0.5'
     * would get parsed into: ('application', 'xhtml', {'q', '0.5'})
     */
