 ...
 * be provided by the core Java {@code String} and {@link StringBuilder} classes, such as the ability to {@link
 * #replace} all occurrences of a given substring in a target string. It also provides easy-to-use methods to convert
 ...
 * @author Rob Harrop
 * @author Rick Evans
 * @author Arjen Poutsma Code copied from Spring source. Modifications made (mostly removal of methods) by Per Wendel.
 */
public abstract class StringUtils {
     ...
     * be considered as single delimiter string, rather than as bunch of potential delimiter characters - in contrast to
     ...
     * {@code null} and the empty String. As a consequence, this method will never return {@code true} for a non-null
     * non-String object.
     * <p>The Object signature is useful for general attribute handling code
     * that commonly deals with Strings but generally has to iterate over Objects since attributes may e.g. be primitive
