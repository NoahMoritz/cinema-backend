 ...
 * allow {@code null} arguments, Assert can be used to validate that contract. Doing this clearly indicates a contract
 ...
 * config initialization code, there is usually no point in falling back to defaults in such methods.
