 ...
 * physical form, but a URL or File handle can just be returned for certain resources. The actual behavior is
...
public interface Resource extends InputStreamResource {
    ...
    /**
     * Return whether the contents of this resource can be read, e.g. via {@link #getInputStream()} or {@link
     * #getFile()}.
     * <p>Will be {@code true} for typical resource descriptors;
     * note that actual content reading may still fail when attempted. However, a value of {@code false} is a definitive
