...
/**
 * Abstract class providing functionality for finding resources based on an Http Servlet request. Code snippets copied
 * from Eclipse Jetty source. Modifications made by Per Wendel.
 */
public abstract class AbstractResourceHandler {
    ...
    /**
     * Add two URI path segments. Handles null and empty paths, path and query params (eg ?a=b or ;JSESSIONID=xxx) and
     * avoids duplicate '/'
     *
