...
public class Request {
    ...
    /**
     * @return the matched route Example return: "/account/:accountId"
     */
    ...
    /**
     * Returns the value of the provided route pattern parameter. Example: parameter 'name' from the following pattern:
     * (get '/hello/:name')
     *
     ...
     * @return the value of the provided queryParam, or default if value is null Example: query parameter 'id' from the
     * following request URI: /hello?id=foo
     */
     ...
     *
     * @param queryParam the query parameter
     * @return the value of the provided queryParam Example: query parameter 'id' from the following request URI:
     * /hello?id=foo
     */
     ...
     *
     * @param queryParam the query parameter
     * @return the encode value of the provided queryParam Example: query parameter 'me' from the URI: /hello?id=fool.
     */
    ...
    /**
     * Gets all the values of the query param Example: query parameter 'id' from the following request URI:
     * /hello?id=foo&amp;id=bar
     *
     * @param queryParam the query parameter
    ...
    /**
     * @return the part of this request's URL from the protocol name up to the query string in the first line of the
     * HTTP request.
     */
    public String uri() {
