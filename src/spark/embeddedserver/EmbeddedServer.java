...
public interface EmbeddedServer {
    ...
    /**
     * Ignites the embedded server, listening on the specified port, running SSL secured with the specified keystore and
     * truststore.  If truststore is null, keystore is reused.
     *
