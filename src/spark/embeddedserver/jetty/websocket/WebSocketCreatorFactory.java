...
/**
 * Factory class to create {@link WebSocketCreator} implementations that delegate to the given handler class.
 *
...
public class WebSocketCreatorFactory {
    ...
    /**
     * Creates a {@link WebSocketCreator} that uses the given handler class/instance for the WebSocket connections.
     *
